            ...
            <div class="tab-content text-center">
                <div class="tab-pane" id="pill1">
                    ...
                    @elseif($lois->enoncear == null)
                        ...
                        <div class="modal fade " id="exampleModalCenterEA" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content bg-dark">
                                    <div class="modal-header">
                ...
                <div class="tab-pane" id="pill2">
                    ...
                    @elseif($lois->etat >= 1)
                        ...
                        @if($lois->preliminaire == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterPRF">
                                Ajouter Rapport de l'étude préliminaire version français
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterPRF" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-dark">
                                        <div class="modal-header">
                        ...
                        @if($lois->preliminairear == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterPRA">
                                Ajouter Rapport de l'étude préliminaire version arabe
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterPRA" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-dark">
                                        <div class="modal-header">
                ...
                <div class="tab-pane" id="pill3">
                    ...
                    @elseif($lois->etat >= 2)
                        ...
                        <hr class="my-2">
                        @if($lois->seance == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterSF">
                                Ajouter Rapport de la séance pléniere
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterSF" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="file-img-box" >
                                        ...
                                        <a href="{{ route('downloadfileS',$lois->seance->id) }}" class="file-download"><i class="fa fa-download"></i></a>
                                    </div>
                                    <div class="file-man-title">
                        ...
                        @if($lois->seancear == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterSA">
                ...
                <div class="tab-pane" id="pill8">
                    @if ( $lois->intervention == null )
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterI">
                            Ajouter Rapport des interventions
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalCenterI" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    @if ( $lois->interventionar == null )
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterIA">
                            Ajouter Rapport des interventions
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalCenterIA" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                ...
                <div class="tab-pane" id="pill4">
                    ...
                    @elseif($lois->etat >= 3)
                        ...
                        @if($lois->complementaire == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterC">
                        ...
                        @if($lois->complementairear == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterCA">
                                Ajouter Rapport complementaire En Arabe
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterCA" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitleA" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                    ...
                    @elseif($lois->etat >= 3 )
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                @if($lois->oui == null )
                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterV">
                ...
                <div class="tab-pane" id="pill6">
                    ...
                    @elseif($lois->etat >= 4)
                        ...
                        @if($lois->getFirstMedia() == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterL">
                                Ajouter Nouvelle lois En Français
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterL" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-dark">
                                        <div class="modal-header">
                        ...
                        @endif
                        @if($lois->loisar == null)
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalCenterLA">
                                Ajouter Rapport complementaire En Arabe
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModalCenterLA" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitleA" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-dark">
                                        <div class="modal-header">
