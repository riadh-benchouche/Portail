            ...
            <div class="col-md-12">
                <div class="card bg-gray-900">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-10">
                                <h4 class="card-title h1 text-white font-weight-bold">Organigramme et Documents administratifs</h4>
                            </div>
                                @can('edit')
                        ...
                        <div class="col-md-6">
                            <div class="container-fluid">
                                <div class="card p-3" style="background-color: white">
                                    <img src="{{asset('black/img/Organi-1.png')}}" alt="organigramme">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a  href="{{ url('/file/download/'.$bibu->id) }}" type="button" class="btn btn-sm btn-primary">Télécharger</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
